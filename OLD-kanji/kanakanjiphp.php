	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
				...
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=130 height=58>				  <!-- MAIN LOGO -->				  
				<a name="top"></a><IMG src="../images/joshuhome.gif" alt="&quot;&quot;" width=130 height=58 border=0 vAlign=textTop>				  </TD>
				<!-- long blank line -->
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TD class=taboff><A href="../vocabulary.php"
						onmouseover="window.status='Vocabulary';return true"
			...
			<TD class=taboffborder><IMG src="../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../counters.php"
			...
			<TD class=taboff><A href="/japanese/joshu/culture.php"
						onmouseover="window.status='Japanese Culture';return true"
			...
			<TR>
				...
				<TD class=tabontitle align=right>
					...
					<SELECT size=1 name="navigateSelect">
                      ...
                      <OPTION class=quick style="background-color: #97b8fd;"  value="/japanese/joshu/video.php">Video</OPTION>
