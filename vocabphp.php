	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
				...
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=130 height=58>				  <!-- MAIN LOGO -->				  <IMG src="/japanese/joshu/images/joshuhome.gif" alt="&quot;&quot;" width=130 height=58 border=0 vAlign=textTop>				  </TD>
				<!-- long blank line -->
