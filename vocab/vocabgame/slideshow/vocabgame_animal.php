...
'../../../images/risu.gif', '../../../images/buta.gif', '../../../images/inu.gif', 
'../../../images/hebi.gif', '../../../images/tokage.gif', '../../../images/sakana.gif',
'../../../images/neko.gif', '../../../images/hitsuji.gif', '../../../images/hato.gif'
);
...
// one function for each sound wav there is
function playSound0() {
...
<!-- end SCRIPT for start vocabulary.htm -->
</HEAD>
...
<script language="JavaScript" type="text/javascript" src="../../../js/overlib400/overlib.js">
...
<!--
<A 
class=trail2 href="contactus.htm"
				onmouseover="return overlib('<a href=\'contactus.htm\'><img src=\'contactus.gif\'></a>', STICKY, MOUSEOFF, WRAP, CELLPAD, 0, CENTER);" 
...
<TR>
	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=29 height=29>
					<IMG src="../../../images/curve_left.gif" alt="image_file"  width=29 height=29></TD>
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=130 height=58>				  <!-- MAIN LOGO -->				  <IMG src="../../../images/joshuhome.gif" alt="image_file"  width=130 height=58 vAlign=textTop border=0>				  </TD>
				<!-- long blank line -->
				<TD bgcolor='ffffff' vAlign=bottom align=center colspan=1 rowspan=1 height=30>&nbsp;
				</TD>
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=29 height=29>
					<IMG src="../../../images/curve_right2.gif" alt="image_file"  width=29 height=29></TD></TR>
			<!-- 2nd row contains long black line -->
			<TR>
				<TD bgcolor='ffffff' vAlign=bottom class=black align=center colSpan=1 rowspan=1 height=5>
					<IMG src="../../../images/spacer.gif" alt="image_file"  width=1 height=1></TD></TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
			<!-- left black border -->
			<TD bgcolor='ffffff' class=black rowspan=2 width=5 height=25><IMG height=25 src="../../../images/spacer.gif" alt="image_file"  width=5></TD>
			...
			<TR>
			<TD class=black valign=bottom height=1><IMG src="../../../images/spacer.gif" alt="image_file"  width=1 height=1></TD>
			<TD class=black valign=bottom height=1><IMG src="../../../images/spacer.gif" alt="image_file"  width=1 height=1></TD>
			<TD class=black valign=bottom height=1><IMG src="../../../images/spacer.gif" alt="image_file"  width=1 height=1></TD>
		...
		<TBODY>
			...
			<TR>
				<!-- black left border -->
				<TD bgcolor='ffffff' class=black width=5 height=30 ><IMG src="../../../images/spacer.gif" alt="image_file"  width=5 height=30 ></TD>
			...
			<TR>
				<TD bgcolor='ffffff' class=black width=5 height=1><IMG src="../../../images/spacer.gif" alt="image_file"  width=5 height=1></TD>
				<TD width="100%" class=shadow colspan=2><IMG src="../../../images/spacer.gif" alt="image_file"  height=1 width=1></TD>
				<TD bgcolor='ffffff' class=black width=5 height=1><IMG src="../../../images/spacer.gif" alt="image_file"  width=5 height=1></TD>
			</TR>
...
<TBODY>
	<TR>
		...
		<TD bgcolor='ffffff' class=black width=5><IMG height=1 src="../../../images/spacer.gif" alt="image_file"  width=5></TD>
				...
				<TR>
					...
					<TD vAlign=top>
						<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY>
							...
							<TR><TD height=5><IMG height=5 src="../../../images/spacer.gif" alt="image_file"  width=1></TD></TR>
							<!-- pink SUBTITLE bar -->
							<TR>
							  <TD class=headline>Vocabulary: Animals (use Firefox, Netscape,
							    or IE 6.0)</TD>
							</TR>
...
<BR>Learn the names of some common animals!
<BR>
...
<embed src="../../../mp3/risu.mp3" hidden=true autostart=false loop=false name="sound0" mastersound>
<embed src="../../../mp3/buta.mp3" hidden=true autostart=false loop=false name="sound1" mastersound>
<embed src="../../../mp3/inu.mp3" hidden=true autostart=false loop=false name="sound2" mastersound>
<embed src="../../../mp3/hebi.mp3" hidden=true autostart=false loop=false name="sound3" mastersound>
<embed src="../../../mp3/tokage.mp3" hidden=true autostart=false loop=false name="sound4" mastersound>
<embed src="../../../mp3/sakana.mp3" hidden=true autostart=false loop=false name="sound5" mastersound>
<embed src="../../../mp3/neko.mp3" hidden=true autostart=false loop=false name="sound6" mastersound>
<embed src="../../../mp3/hitsuji.mp3" hidden=true autostart=false loop=false name="sound7" mastersound>
<embed src="../../../mp3/hato.mp3" hidden=true autostart=false loop=false name="sound8" mastersound>
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<!-- first row, image -->
	<tr><td class="picture"><img name="image" src="../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound0',0)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onClick="showNext(1)"></td>
		<td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound1',1)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onClick="showNext(2)"></td>
		<td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound2',2)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onClick="showNext(3)"></td></tr>
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<!-- second row, image -->
	<tr><td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound3',3)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onclick=showNext(4)></td>
		<td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound4',4)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onclick=showNext(5)></td>
		<td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound5',5)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onclick=showNext(6)></td></tr>
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<!-- third row, image -->
	<tr><td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound6',6)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onclick=showNext(7)></td>
		<td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound7',7)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle" onclick=showNext(8)></td>
		<td class="picture"><img name="image" src = "../../../images/blankimage.gif" alt="image_file"  height=125 width=150 onClick="EvalSound('sound8',8)"></td>
		<td><img src="../../../images/blankarrow.gif" alt="image_file"  name="arrowmiddle"></td></tr>
...
<FONT STYLE="FONT-SIZE:9px">* Note: Snake image was copied from <BR>the <A HREF="http://www.sla.purdue.edu/fll/JapanProj/FLClipart/default.html" target="_blank" STYLE="FONT-SIZE:9px">Royalty-Free Clip Art Collection <BR>for Foreign/Second Language Instruction</A></FONT>
