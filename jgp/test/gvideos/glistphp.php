<!-- HEADERS -->
<!DOCTYPE phpL PUBLIC "-//W3C//DTD phpL 4.0 Transitional//EN">
<phpL lang="ja">
<HEAD>
<TITLE>JOSHU - Japanese Online Self-Help Utility</TITLE>
<META NAME=GENERATOR content="MSphpL 6.00.2800.1400">
<META NAME=AUTHOR content="Nan Puthaaroon">
	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
				...
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=130 height=58>				  <!-- MAIN LOGO -->				  <IMG src="../../images/joshuhome.gif" width=130 height=58 vAlign=textTop border=0>				  </TD>
				<!-- long blank line -->
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TD class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../../index.php"
						onmouseover="window.status='Return HOME';return true"
						onmouseout="window.status='';return true">Home</A></TD>
			<TD class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../../basics.php"
						onmouseover="window.status='Beginner Level Japanese';return true"
						onmouseout="window.status='';return true">Learn the Basics</A></TD>
			<TD class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD rowspan=1 class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD rowspan=1 class=taboff><A href="../../vocabulary.php"
						onmouseover="window.status='Do the tango';return true"
						onmouseout="window.status='';return true">Vocabulary</A></TD>
			<TD rowspan=1 class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD rowspan=1 class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD rowspan=1 class=taboff><A href="../../kanakanji.php"
						onmouseover="window.status='Verb Conjugation';return true"
						onmouseout="window.status='';return true">Kana/Kanji</A></TD>
			<TD rowspan=1 class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD rowspan=2 class=tabonborder><IMG src="../../images/tabon-left.gif"></TD>
			<TD rowspan=2 class=tabon><A href="../../grammar.php"
						onmouseover="window.status='Grammar';return true"
						onmouseout="window.status='';return true">Grammar</A></TD>
			<TD rowspan=2 class=tabonborder><IMG src="../../images/tabon-right.gif"></TD>

			<TD rowspan=1 class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD rowspan=1 class=taboff><A href="../../counters.php"
						onmouseover="window.status='Counters';return true"
						onmouseout="window.status='';return true">Counters</A></TD>
			<TD rowspan=1 class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../../reading.php"
						onmouseover="window.status='Kanji flashcards';return true"
						onmouseout="window.status='';return true">Reading</A></TD>
			<TD class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../../video.php"
						onmouseover="window.status='Video';return true"
						onmouseout="window.status='';return true">Video</A></TD>
			<TD class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../../culture.php"
						onmouseover="window.status='Culture';return true"
						onmouseout="window.status='';return true">Culture</A></TD>
			<TD class=taboffborder><IMG src="../../images/taboff-right.gif"></TD>

			<TD class=taboffborder><IMG src="../../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="../../links.php"
		...
		<TBODY>
			...
			<TR>
				...
				<TD class=tabontitle align=right>
					...
					// Web/phpL page is set with OPTION SELECTED VALUE
					...
					<SELECT size=1 name="navigateSelect">
                      ...
                      <OPTION class=quick style="background-color: #538bff;"  value="../../index.php">Home</OPTION>
                      <OPTION class=quick style="background-color: #97b8fd;"  value="../../basics.php">Learn the Basics</OPTION>
                      <OPTION class=quick style="background-color: #538bff;"  value="../../vocabulary.php">Vocabulary</OPTION>
                      <OPTION class=quick style="background-color: #97b8fd;"  value="../../kanakanji.php">Kana/Kanji</OPTION>
                      <OPTION class=quick style="background-color: #538bff;"  value="../../grammar.php">Grammar</OPTION>
                      <OPTION class=quick style="background-color: #97b8fd;"  value="../../counters.php">Counters</OPTION>
                      <OPTION class=quick style="background-color: #538bff;"  value="../../reading.php">Reading</OPTION>
                      <OPTION class=quick style="background-color: #97b8fd;"  value="../../video.php">Video</OPTION>
                      <OPTION class=quick style="background-color: #538bff;"  value="../../culture.php">Culture</OPTION> 
                      <OPTION class=quick style="background-color: #97b8fd;"  value="../../links.php">Links</OPTION>
                    </SELECT> 
					&nbsp;
