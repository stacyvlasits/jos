	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR>
				...
				<TD bgcolor='ffffff' vAlign=bottom colspan=1 rowspan=3 width=130 height=58>				  <!-- MAIN LOGO -->				  <IMG src="images/joshuhome.gif" alt="&quot;&quot;" width=130 height=58 border=0 vAlign=textTop>				  </TD>
				<!-- long blank line -->
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TD rowspan=2 class=tabon><A href="/japanese/joshu//japanese/joshu/index.php"
			...
			<TD class=taboffborder><IMG src="images/taboff-left.gif"></TD>
			<TD class=taboff><A href="/japanese/joshu/vocabulary.php"
