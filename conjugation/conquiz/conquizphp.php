...
<table width="90%" border="2" align="center" cellPadding=2 cellspacing=0 bordercolor="#000000">
  <tr bordercolor="#F7FE88">
    <TD width="65%" class=tabontitle><FONT COLOR="#538BFF">&nbsp;J</FONT>apanese
    ...
    <div align="right" border=0 >
	  <span class="style1"><a href="../../gquiz.php">Return
      to Grammar Practice Quizzes page</a></span></div></TD>
  </tr>
  <TR>
  <TD colspan="2" class=headline border-top=2 border-bottom=2 border-right-=0 border-left=0>Conjugation</TD>
  </TR>
