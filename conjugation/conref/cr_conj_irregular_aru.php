...
<SCRIPT language=JavaScript src="../../js/verbs_flashcards_irregular_aru.js" type=text/javascript></SCRIPT>
...
<br>
<p>
<font class=category>Verb Conjugation - Irregular: ある (to have/to be)
...
<table class=verbtable cellspacing=0> <!--<table border="1" cellpadding="0" cellspacing="0">-->
	...
	<!-- ~a -->
		...
		<!-- plain negative -->
			...
			<td><input class=aiueo-off type="text" name="aiueo" value=""></td>
			...
			<td align=left><font class=translation>to not</font> <font class=translation-verb>have/be</font></td>
		</tr>
		<tr>
		<!-- ba conditional negative -->
			...
			<td align=right>&nbsp;</td>
			<td align=left><font class=translation>If </font><font class=translation-verb>I
			    don't have/it isn't (something), </font></td>
		</tr>
		<tr>
		<!-- passive -->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
			<td class=cell><input class=aiueo-off type="text" name="aiueo" value=""></td>
			<td><input class=conjugation type="text" name="conjugation" value=""></td>
			<td class=blank>&nbsp;</td>
	...
	<!-- ~i -->
		...
		<!-- polite -->
			...
			<td align=right><font class=translation>&nbsp;</font></td>
			<td align=left><font class=translation>to</font> <font class=translation-verb>have/be</font></td>
		</tr>
		<tr>
		<!-- polite negative-->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
	...
	<!-- ~e -->
		...
		<!-- ba conditional -->
			...
			<td align=right><font class=translation>&nbsp;</font></td>
			<td align=left><font class=translation>If I</font> <font class=translation-verb>have/it
			    is (something), ...</font></td>
		</tr>
		<tr>
		<!-- command (plain) -->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
