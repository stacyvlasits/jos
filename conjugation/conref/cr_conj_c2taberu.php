...
<SCRIPT language=JavaScript src="../../js/verbs_flashcards_class2.js" type=text/javascript></SCRIPT>
...
<center>
  ...
  <br>
  <p><font class=category>Verb Conjugation - Class II: 食べる（たべる、to eat)
</font></p>
 <p><br>
...
<table class=verbtable cellspacing=0> <!--<table border="1" cellpadding="0" cellspacing="0">-->
	...
	<!-- ~a -->
		...
		<!-- plain negative -->
			...
			<td align=left><font class=translation-verb>eat</font></td>
		</tr>
		<tr>
		<!-- ba conditional negative -->
			...
			<td><input class=conjugation type="text" name="conjugation" value=""></td>
			<td class=blank>&nbsp;</td>
			<td><input type="checkbox" name="checkbox" onClick="setVerb(1)">
		...
		<!-- passive -->
			...
			<td align=left><font class=translation-verb>eaten (by someone)</font></td>
		</tr>
		<tr>
		<!-- causative -->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
		...
		<!-- passive causative -->
			...
			<font class=verbtype>passive causative</font></td>
			<td align=right><font class=translation>to be made to&nbsp;</font></td>
			<td align=left><font class=translation-verb>eat (by someone)</font></td>
		</tr>
	...
	<!-- ~i -->
		...
		<!-- command (polite) -->
			...
			<td align=left><font class=translation-verb>Eat. (command)</font></td>
		</tr>
		<tr>
		<!-- tai form -->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
