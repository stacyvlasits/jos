...
<SCRIPT language=JavaScript src="../../js/verbs_flashcards_class3_kuru.js" type=text/javascript></SCRIPT>
...
<center>
  <p><br>
      <font class=category>Verb Conjugation - Class III: 来る(くる、to come)
  </font></p>
  <p>
  <br>
...
<table class=verbtable cellspacing=0> <!--<table border="1" cellpadding="0" cellspacing="0">-->
	...
	<!-- ~a -->
		...
		<!-- passive -->
			...
			<td align=left><font class=translation-verb>came (by someone)</font></td>
		</tr>
		<tr>
		<!-- causative -->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
		...
		<!-- passive causative -->
			...
			<td align=left><font class=translation-verb>come (by someone)</font></td>
		</tr>
	...
	<!-- ~i -->
		...
		<!-- command (polite) -->
			...
			<td align=left><font class=translation-verb>Come. (command)</font></td>
		</tr>
		<tr>
		<!-- tai form -->
			<td align=right><input class=stem type="text" name="stem" value=""></td>
