...
<p class="instructionLine">Study the example sentences, then write sentences equivalent to the English sentences given. Write numbers and counters (including question words) in hiragana, but for other words, use the Kanji characters you have learned in the first semester (and Katakana where appropriate). <FONT COLOR="#FF0000">Please end the sentences with「。」 (Japanese period).</FONT><br><br>
(e.g.,)<br>
Threre are 3 cats.:
