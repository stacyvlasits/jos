...
var name = new Array('image1', 'text1', 'image2', 'text2', 'image3', 'text3', 'image4', 'text4', 'image5', 'text5', 'image6', 'text6', 'image7', 'text7', 'image8', 'text8');
var user = new Array();
...
runclk();
for (i = 0; i <= 15; i++) {
document.f[('img'+i)].src = "images/image0.gif";
   }
}
function runclk() {
...
randomName = name[randomI];
temparray[2] = map[x];
savedName = name[x];
map[x] = temparray[1];
name[x] = randomName;
map[temparray[0]] = temparray[2];
name[randomI] = savedName;
      }
   }
}
...
if (oktoclick) {
oktoclick = false; 
document.f[('img'+but)].src = 'images/' +name[but]+'.gif';
if (ctr == 0) {
ctr++;
clickarray[0] = but;
oktoclick = true;
...
document.f[('img'+clickarray[0])].src = "images/image0.gif";
oktoclick = true;
} else {
...
document.f[('img'+clickarray[1])].src = "images/image0.gif";
   }
}
if (map[clickarray[0]] == map[clickarray[1]]) {
...
<center>
<h2>Memory Game with Counters</h2>
<form name="f"> 
...
document.write('<img src="../../images/image0.gif" name="img'+((4*r)+c)+'" border="0">');
document.write('</a></td>');
}
document.write('</tr>');
}
