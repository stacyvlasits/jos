...
runclk();
for (i = 0; i <= 15; i++) {
document.f[('img'+i)].src = "images2/image0.gif";
   }
}
function runclk() {
...
function showimage(but) {
	if (oktoclick) {
	oktoclick = false; 
	document.f[('img'+but)].src = 'images2/'+theName[but]+'.gif';
	if (ctr == 0) {
	ctr++;
	clickarray[0] = but;
	oktoclick = true;
...
document.f[('img'+clickarray[0])].src = "images2/image0.gif";
oktoclick = true;
} else {
...
document.f[('img'+clickarray[1])].src = "images2/image0.gif";
   }
}
if (map[clickarray[0]] == map[clickarray[1]]) {
...
<center>
<h2>Memory Game with Counters 2</h2>
drawings by A. Stites<br /><br />
<form name="f"> 
...
document.write('<img src="images2/image0.gif" name="img'+((4*r)+c)+'" border="0">');
document.write('</a></td>');
}
document.write('</tr>');
}
