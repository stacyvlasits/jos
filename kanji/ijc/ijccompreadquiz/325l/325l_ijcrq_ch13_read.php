...
<FORM name="quiz">
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('じょし',this.value,2)" style="width: 150px;">
    </INPUT>&nbsp;&nbsp;&nbsp;&nbsp;<font color = #666666>English </font>
	...
	<! Question 3>
	<div class="questionLineOdd"><b>3. </b>&nbsp;&nbsp;一生懸命&nbsp;&nbsp;
	<INPUT name="answer" type="text" onChange="checkAnswer('いっしょうけんめい',this.value,4)" style="width: 150px;">
    </INPUT>&nbsp;&nbsp;&nbsp;&nbsp;<font color = #666666>English </font>
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('ふくざつ',this.value,6)" style="width: 150px;">
    </INPUT>&nbsp;&nbsp;&nbsp;&nbsp;<font color = #666666>English </font>
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('ながの',this.value,8)" style="width: 150px;">
	</INPUT>&nbsp;&nbsp;&nbsp;&nbsp;<font color = #666666>English </font>
     <INPUT name="answer" type="text" onChange="checkAnswer('c_c.',this.value,9)" style="width: 20px;">
	</INPUT>
    <div class="symbols">
    <IMG SRC="../../../../grammar/gimages/blank.gif">
    <IMG SRC="../../../../grammar/gimages/blank.gif"></div>
