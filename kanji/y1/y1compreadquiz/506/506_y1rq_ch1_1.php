...
<div class="backgroundLayer" align="center" id="quiz">
  ...
  <div class="quizlistLine"><a href="../../../kanji_yookoso1.php">Return to Kanji 
    page</a></div> 
<p class="instructionLine"> Type the reading of the Kanji compounds <strong><font color = "red">in Hiragana</font></strong>
...
<FORM name="quiz">
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('にほん_にっぽん',this.value,0)" style="width: 150px;">
	</INPUT> Japan
	...
	<! Question 6>
	<div class="questionLineEven"><b>6. </b>&nbsp;&nbsp;二月生まれ&nbsp;&nbsp;
	  <INPUT name="answer" type="text" onChange="checkAnswer('にがつうまれ',this.value,5)" style="width: 150px;">
    </INPUT>one who was born in February
	<IMG SRC="../../../../grammar/gimages/blank.gif" class="symbols">
	<p class="translationLine"></p></div>
