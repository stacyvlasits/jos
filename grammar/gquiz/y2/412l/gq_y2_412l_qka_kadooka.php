...
<FORM name="quiz">
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('ぶんぽうクイズがあるかどうか_ぶんぽうクイズがあるか、どうか',this.value,0)" style="width: 200px;">
	</INPUT>わかりません。
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('いつファイナルがあるか_',this.value,1)" style="width: 200px;">
    </INPUT>わすれました。
	<IMG SRC="../../../gimages/blank.gif" class="symbols">
	<p class="translationLine"></p></div>
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('雪がふるかどうか_雪がふるか、どうか',this.value,2)" style="width: 200px;">
	</INPUT>わかりません。
	<IMG SRC="../../../gimages/blank.gif" class="symbols">
	<p class="translationLine"></p></div>
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('町田さんがアメリカに来るかどうか_町田さんがアメリカに来るか、どうか',this.value,3)" style="width: 200px;">
    </INPUT>しりません。
	<IMG SRC="../../../gimages/blank.gif" class="symbols">
	<p class="translationLine"></p></div>
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('スミスさんがどこにすんでいるか_スミスさんがどこに住んでいるか',this.value,4)" style="width: 200px;">
	</INPUT>しりません。
	<IMG SRC="../../../gimages/blank.gif" class="symbols">
	<p class="translationLine"></p></div>
	...
	<INPUT name="answer" type="text" onChange="checkAnswer('てんぷらが好きかどうか_てんぷらが好きか、どうか',this.value,5)" style="width: 200px;">
