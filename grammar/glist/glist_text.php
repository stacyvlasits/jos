  ...
  <?php
	...
	foreach($pairs as $pair){
		...
		if ($hasVideos){
			...
			$arg = urlencode($pair->grammar_topic_name);
			print "<a href = 'http://www.laits.utexas.edu/japanese/joshu/grammar/gvideos/gvideos.php?q=".$arg."'>Watch example videos</a></li></ul>";
		}
		echo "</li>";
	}
	echo "</ul>";
