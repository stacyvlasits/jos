...
<div id="wrapper">
	...
	$client = new DaseClient('japanese_grammar', 'php','http://dase.laits.utexas.edu');
  ...
  echo "-->";
    ...
    <div id="video">
		...
		if($video) {
			...
			echo "<object width=\"320\" height=\"260\"><param name=\"movie\" value=\"".$r->app_root.$r->items[0]->media->quicktime."\"></param><embed src=\"http://dase.laits.utexas.edu/".$r->items[0]->media->quicktime."\" height=\"260\" width=\"320\" controller=\"true\" cache=\"true\" autoplay=\"false\"></embed></object>";
    ...
    <div id="footer">
   		Videos edited by Adrian LaGuette and Chiang Leng, &#169; 2009 - Naoko Suito　　
    </div>
