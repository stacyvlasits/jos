...
class=trail2 href="Culture.php"
				onmouseover="return overlib('<a href=\'Culture.php\'><img src=\'Culture.gif\'></a>', STICKY, MOUSEOFF, WRAP, CELLPAD, 0, CENTER);" 
...
<TR>
	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TD rowspan=2 class=tabon><A href="/japanese/joshu/basics.php"
			...
			<TD class=taboffborder><IMG src="images/taboff-left.gif"></TD>
			<TD class=taboff><A href="/japanese/joshu/kanakanji.php"
						onmouseover="window.status='Kana/Kanji flashcards';return true"
