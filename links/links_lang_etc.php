...
<p>
  ...
  <blockquote>
     ...
     <p>&nbsp;</p>
      ...
      <p><b><a href="links_lang_kana.php"><img src="../../button/t_close.gif" width="16" height="16" border="0"></a><a href="links_lang_kana.php">Kana</a></b></p>
	 ...
	 <p><B><a href="links_lang_reading.php"><img src="../../button/t_close.gif" width="16" height="16" border="0"></a><a href="links_lang_reading.php">Reading Materials</a></B></p>
	 ...
	 <p><B><a href="links_lang_listening.php"><img src="../../button/t_close.gif" alt="link to listening materials links" width="16" height="16" border="0"></a><a href="links_lang_listening.php">Listening
	  ...
	  <p><b><a href="links_language.php"><img src="../../button/t_open.gif" width="16" height="16" border="0"></a>Etc.</b></p>
	  
	  <ul>
	    <li><a href="../kyookotoba/" target="_blank">京言葉 (Kyoo
	        Kotoba) The Language of Kyoko</a>, site translated by Tan Nguyen (UT
	        Austin) </li>
	    <li><strong><a href="http://www.dik.co.jp/seken/gogen.html" target="_blank">語源探偵団（ごげんたんていだん）</a></strong></li>
	    <li><a href="http://nlp.nagaokaut.ac.jp/hougen/" target="_blank">ふるさとの方言</a> </li>
	    <li><!--<a href="http://www.asahi-net.or.jp/~ft5k-ymd/Yn.html">-->Names in Katakana (Temporarily Down) </li>
	    <li><a href="http://www.manythings.org/japanese/signs/" target="_blank">Reading Japanese Signs</a> </li>
	  </ul>
	  </blockquote>
