...
<META http-equiv=Page-Enter content="progid:DXImageTransform.Microsoft.GradientWipe(GradientSize=.50,wipeStyle=1,motion='forward')">
	...
	<META content="MSphpL 6.00.2800.1400" name=GENERATOR>
...
</SCRIPT><!-- end SCRIPT for verbs.php -->
</HEAD>
...
<!--
<A 
class=trail2 href="culture.php"
				onmouseover="return overlib('<a href=ｼ'culture.phpｼ'><img src=ｼ'culture.gifｼ'></a>', STICKY, MOUSEOFF, WRAP, CELLPAD, 0, CENTER);" 
...
<TR>
	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TD rowspan=2 class=tabon><A href="/japanese/joshu/kanakanji.php"
						onmouseover="window.status='kana kanji';return true"
			...
			<TR>
				...
				<TD class=tabontitle align=right>
					...
					<SELECT size=1 name="navigateSelect">
                      ...
                      <OPTION class=quick style="background-color: #97b8fd;"  value="conjugation.php">Conjugation</OPTION>
                      ...
                      <OPTION class=quick style="background-color: #538bff;"  value="kanakanji.php">Kana/Kanji</OPTION>
