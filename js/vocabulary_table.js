...
//		document.writeln('		<IMG SRC="../joshu/images/audio.gif" WIDTH="16" HEIGHT="15" BORDER="0" ALT=""></A>');
		...
		///*
		document.writeln('<applet code=AudioButton.class name="Audio' + i + '" width=16 height=15>');
		...
		document.writeln('<embed src="../joshu/images/audio.mov" target="myself" width="50" height="34" href="../joshu/wav/iie.mov" autoplay="');
		...
		*/
		...
		document.writeln('		onClick="PlaySound(\'' + vocabListArray[cat][i].audio + '\')">');
		*/
