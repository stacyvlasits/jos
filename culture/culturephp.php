...
<TR>
	...
	<TD width="80%" align=center>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TD class=taboffborder><IMG src="../images/taboff-left.gif"></TD>
			<TD class=taboff><A href="/japanese/joshu/listen.php"
			...
			<TR>
				...
				<TD class=tabontitle align=right>
					...
					<SELECT size=1 name="navigateSelect">
                      ...
                      <OPTION class=quick style="background-color: #97b8fd;"  value="/japanese/joshu/listen.php">Listening/Speaking</OPTION>
